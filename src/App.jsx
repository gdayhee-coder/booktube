...
const LISTEN = [
  { level:"1단계 · 처음 시작해요", desc:"말이 짧고 쉬워서 그림만 봐도 이해돼요", color:"#8FA07E",
    shows:["Peppa Pig","Maisy Mouse","Bing","Max and Ruby","Trotro","Meg and Mog","Penelope","Timmy Time","Poppy Cat","Little Baby Bum","Ben and Ed","Kipper","Spot","Louie","Olivia"] },
  { level:"2단계 · 귀가 익숙해지면", desc:"이야기가 있는 에피소드로 넘어가요", color:"#C9A96B",
    shows:["Caillou","Curious George","Ben and Holly","Charlie and Lola","Octonauts","Dora the Explorer","Franklin","Clifford the Big Red Dog","Arthur's Family Values","Little Bear","Angelina Ballerina","Toopy and Binoo","Blue's Clues","Wonder Pets","Berenstain Bears Little"] },
  { level:"3단계 · 술술 들리기 시작하면", desc:"말이 빠르고 내용이 풍부한 시리즈예요", color:"#B48A76",
    shows:["Arthur","The Magic School Bus","Wild Kratts","Horrid Henry","Geronimo Stilton","The Berenstain Bears","Odd Squad","Molly of Denali","Sarah and Duck","Word Girl","Magic Tree House","Junie B Jones","The Boxcar Children"] },
];
...
const KNOWLEDGE = [
  ...
  { cat:"🔬 과학·자연", color:"#8FA07E",
    items:["National Geographic Kids","SciShow Kids","Dr Binocs Show","Crash Course Kids","Mark Rober","Kurzgesagt","Peekaboo Kidz"] },
  { cat:"🏛 역사·교양", color:"#C9A96B",
    items:["Simple History","Horrible Histories","Crash Course World History","TED-Ed","Free School","Homeschool Pop","Kids Learning Tube"] },
];
...
const Ic = {
  headphone: (c="#7E9469", s=18) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <path d="M8 18v-2a8 8 0 0116 0v2" stroke={c} strokeWidth="2.3" strokeLinecap="round" fill="none"/>
      <rect x="6" y="17" width="4.6" height="8.2" rx="2.3" fill={c}/>
      <rect x="21.4" y="17" width="4.6" height="8.2" rx="2.3" fill={c}/>
    </svg>
  ),
  book: (c="#7E9469", s=18) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <path d="M16 9C13.3 7.4 9.2 7.4 7.1 8C6.3 8.2 5.6 9 5.6 9.9V22.5c0 1.1 1 1.9 2.1 1.6C9.7 23.3 13.3 23.3 16 25V9Z" fill={c}/>
      <path d="M16 9C18.7 7.4 22.8 7.4 24.9 8C25.7 8.2 26.4 9 26.4 9.9V22.5c0 1.1-1 1.9-2.1 1.6C22.3 23.3 18.7 23.3 16 25V9Z" fill={c} opacity="0.5"/>
    </svg>
  ),
  key: (c="#7E9469", s=16) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <circle cx="12" cy="13" r="6.5" fill="none" stroke={c} strokeWidth="2.4"/>
      <path d="M17 18l9 9M22 23l3-3M25.5 26.5l2.5-2.5" stroke={c} strokeWidth="2.4" strokeLinecap="round"/>
    </svg>
  ),
  user: (c="#7E9469", s=16) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <circle cx="16" cy="11" r="5.5" fill={c}/>
      <path d="M6 26c0-5.5 4.5-9 10-9s10 3.5 10 9" fill={c} opacity="0.55"/>
    </svg>
  ),
  search: (c="#7E9469", s=18) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <circle cx="14" cy="14" r="8.5" fill="none" stroke={c} strokeWidth="2.6"/>
      <path d="M20.5 20.5L27 27" stroke={c} strokeWidth="2.8" strokeLinecap="round"/>
    </svg>
  ),
  star: (c="#D9C286", s=16, filled=true) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <path d="M16 5l3.4 7.1 7.8 1-5.7 5.5 1.4 7.8L16 22.6l-7 3.8 1.4-7.8-5.7-5.5 7.8-1L16 5Z" fill={filled ? c : "none"} stroke={c} strokeWidth="2"/>
    </svg>
  ),
  seedling: (c="#9DB088", s=17) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <path d="M16 27V17" stroke={c} strokeWidth="2.4" strokeLinecap="round"/>
      <path d="M16 17c0-5-4-8-10-8 0 5 4 8 10 8Z" fill={c} opacity="0.55"/>
      <path d="M16 14c0-4 3.5-6.5 8.5-6.5 0 4-3.5 6.5-8.5 6.5Z" fill={c}/>
    </svg>
  ),
  flame: (c="#C99F86", s=16) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <path d="M16 5c1 4-3 5.5-3 9.5 0 2 1.3 3.5 3 3.5s3-1.5 3-3.5c2 1.5 3 4 3 6.5 0 4.5-3.6 7.5-8 7.5s-8-3-8-7.5c0-6 4.5-9 6-12 .8-1.7 1.5-2.7 4-4Z" fill={c}/>
    </svg>
  ),
  check: (c="#fff", s=14) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <path d="M6 17l6.5 6.5L26 9" stroke={c} strokeWidth="3.4" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    </svg>
  ),
  lock: (c="#7E9469", s=30) => (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      <rect x="7" y="14" width="18" height="13" rx="3" fill={c} opacity="0.18"/>
      <rect x="9" y="16" width="14" height="10" rx="2.5" fill={c}/>
      <path d="M11 14v-3a5 5 0 0110 0v3" stroke={c} strokeWidth="2.4" fill="none" strokeLinecap="round"/>
...
export default function App() {
  ...
  const doLogin = async () => {
    ...
    try {
      ...
      setIdIn(""); setPinIn(""); setShowLogin(false);
  ...
  return (
    <div style={{ fontFamily:FF, background:C.bg, minHeight:"100vh" }}>
      ...
      {locked && (
        <div style={{ position:"fixed", inset:0, background:"rgba(37,43,35,0.85)", zIndex:200, display:"flex", alignItems:"center", justifyContent:"center", padding:20 }}>
          <div style={{ background:C.paper, borderRadius:18, padding:"28px 24px", maxWidth:340, width:"100%", textAlign:"center", boxShadow:"0 10px 40px rgba(0,0,0,0.3)" }}>
            <div style={{ display:"flex", justifyContent:"center", marginBottom:10 }}>{Ic.lock(C.woodDark, 34)}</div>
      ...
      {/* 학생 로그인 모달 — 헤더 어디서나 열 수 있음 */}
      {showLogin && !user && (
        <div style={{ position:"fixed", inset:0, background:"rgba(37,43,35,0.5)", zIndex:150, display:"flex", alignItems:"center", justifyContent:"center", padding:20 }}
          onClick={() => setShowLogin(false)}>
          <div onClick={(e) => e.stopPropagation()}
            style={{ background:C.paper, borderRadius:18, padding:"26px 22px", maxWidth:340, width:"100%", boxShadow:"0 10px 40px rgba(0,0,0,0.25)" }}>
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:14 }}>
              <div style={{ fontSize:16, fontWeight:800, color:C.text, display:"flex", alignItems:"center", gap:7 }}>{Ic.key(C.woodDark, 17)} 학생 로그인</div>
              <button onClick={() => setShowLogin(false)} style={{ background:"none", border:"none", fontSize:18, color:C.textMuted, cursor:"pointer", lineHeight:1 }}>✕</button>
            </div>
            <div style={{ fontSize:11.5, color:C.textMid, marginBottom:14, lineHeight:1.6 }}>선생님께 받은 아이디와 비밀번호로 로그인하면<br/>흘려듣기 기록이 저장돼요.</div>
            <input value={idIn} onChange={(e) => setIdIn(e.target.value)} placeholder="아이디 (예: bt1234)"
              style={{ width:"100%", padding:"11px 13px", border:`1.5px solid ${C.border}`, borderRadius:9, fontSize:14, outline:"none", fontFamily:FF, background:C.bg, marginBottom:8, boxSizing:"border-box" }} />
            <input value={pinIn} onChange={(e) => setPinIn(e.target.value.replace(/\D/g,"").slice(0,4))} type="password" inputMode="numeric" placeholder="비밀번호 4자리"
              ...
              style={{ width:"100%", padding:"11px 13px", border:`1.5px solid ${C.border}`, borderRadius:9, fontSize:14, outline:"none", fontFamily:FF, background:C.bg, marginBottom:12, textAlign:"center", letterSpacing:"6px", boxSizing:"border-box" }} />
            ...
            {loginErr && (
              <div style={{ marginTop:10 }}>
                <div style={{ fontSize:11.5, color:C.warn, marginBottom:6 }}>{loginErr}</div>
                <button onClick={() => { setLoginErr(""); setIdIn(""); setPinIn(""); }}
                  style={{ padding:"6px 12px", background:"none", border:`1.5px solid ${C.border}`, borderRadius:20, fontSize:10.5, fontWeight:700, color:C.textMid, cursor:"pointer", fontFamily:FF }}>
                  다시 입력하기
                </button>
              </div>
            )}
            {!loginErr && <div style={{ fontSize:10.5, color:C.textMuted, marginTop:10, textAlign:"center" }}>계정이 없다면 선생님께 문의해주세요.</div>}
          </div>
        </div>
      )}
        ...
        <div style={{ position:"fixed", inset:0, background:"#252B23", zIndex:100, display:"flex", flexDirection:"column" }}>
          <div style={{ display:"flex", alignItems:"center", gap:12, padding:"12px 16px", background:C.woodDark }}>
            ...
            <button onClick={() => toggleFav(playing)}
              ...
              {isFav(playing) ? (<span style={{ display:"inline-flex", alignItems:"center", gap:5 }}>{Ic.book("#FDFCF4",13)} 꽂아둠</span>) : "＋ 책꽂이"}
            </button>
          </div>
        ...
        <div style={{ maxWidth:860, margin:"0 auto" }}>
          <div style={{ display:"flex", alignItems:"center", gap:11, marginBottom:12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize:9.5, color:"rgba(69,82,57,0.55)", marginTop:2 }}>© 북튜브 · 무단 복제·배포 금지</div>
            </div>
            <div style={{ marginLeft:"auto", display:"flex", gap:6 }}>
              <button onClick={() => setView(view === "listen" ? "search" : "listen")}
                style={{ display:"flex", alignItems:"center", gap:5, padding:"8px 13px", background:view==="listen" ? "#FFFFFF" : "rgba(255,255,255,0.5)", color:view==="listen" ? "#5E7049" : "#455239", border:"none", borderRadius:20, fontSize:12.5, fontWeight:700, cursor:"pointer", fontFamily:FF }}>
                {Ic.headphone(view==="listen" ? "#5E7049" : "#455239", 15)} 흘려듣기
              </button>
              <button onClick={() => setView(view === "favs" ? "search" : "favs")}
                style={{ display:"flex", alignItems:"center", gap:5, padding:"8px 13px", background:view==="favs" ? "#FFFFFF" : "rgba(255,255,255,0.5)", color:view==="favs" ? "#5E7049" : "#455239", border:"none", borderRadius:20, fontSize:12.5, fontWeight:700, cursor:"pointer", fontFamily:FF }}>
                {Ic.book(view==="favs" ? "#5E7049" : "#455239", 15)} 내 책꽂이 {favs.length > 0 && `(${favs.length})`}
              </button>
              {user ? (
                <button onClick={doLogout}
                  style={{ display:"flex", alignItems:"center", gap:5, padding:"8px 13px", background:"rgba(255,255,255,0.5)", color:"#455239", border:"none", borderRadius:20, fontSize:12.5, fontWeight:700, cursor:"pointer", fontFamily:FF }}>
                  {Ic.user("#455239", 14)} {user.name || user.id}
                </button>
              ) : (
                <button onClick={() => setShowLogin(true)}
                  style={{ display:"flex", alignItems:"center", gap:5, padding:"8px 13px", background:"rgba(255,255,255,0.5)", color:"#455239", border:"none", borderRadius:20, fontSize:12.5, fontWeight:700, cursor:"pointer", fontFamily:FF }}>
                  {Ic.key("#455239", 14)} 로그인
                </button>
              )}
            </div>
          </div>
          ...
          <div style={{ display:"flex", gap:8, marginBottom:14 }}>
            ...
            <button onClick={() => search()} disabled={loading || !q.trim()}
              ...
              {loading ? "…" : (<span style={{ display:"inline-flex", alignItems:"center", gap:6 }}>{Ic.search("#FDFCF4", 15)} 검색</span>)}
            </button>
          </div>
          {/* 책등 장식 — 선반 위 미니 책들 */}
      ...
      <div style={{ maxWidth:860, margin:"0 auto", padding:"18px 20px 40px" }}>
        {view === "listen" ? (
          <div>
            <div style={{ fontSize:15, fontWeight:800, color:C.text, marginBottom:4, display:"flex", alignItems:"center", gap:6 }}>{Ic.headphone(C.woodDark, 17)} 흘려듣기 코너</div>
            ...
            <div style={{ background:C.paper, border:`1.5px solid ${C.border}`, borderRadius:14, padding:"14px 16px", marginBottom:18, boxShadow:"3px 4px 0 rgba(107,124,96,0.1)" }}>
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:12 }}>
                <div>
                  <div style={{ fontSize:13.5, fontWeight:800, color:C.text, display:"flex", alignItems:"center", gap:6 }}>{Ic.seedling(C.wood, 16)} 오늘의 흘려듣기 30분</div>
                  <div style={{ fontSize:11, color:C.textMuted, marginTop:2 }}>
                    {streak > 0 ? (<span style={{ display:"inline-flex", alignItems:"center", gap:3 }}>{Ic.flame("#C99F86", 12)} {streak}일 연속 듣는 중!</span>) : "오늘부터 시작해볼까요?"} · 이번 달 {monthCount}일
                  </div>
                </div>
                {user ? (
                  <button onClick={toggleToday}
                    ...
                    {doneToday ? (<span style={{ display:"inline-flex", alignItems:"center", gap:5 }}>{Ic.check("#FDFCF4", 12)} 완료!</span>) : "듣기 완료"}
                  </button>
                ) : null}
              </div>
              {!user && (
                <div style={{ marginBottom:12 }}>
                  ...
                  {loginErr && (
                    <div>
                      <div style={{ fontSize:11, color:C.warn, marginBottom:8 }}>{loginErr}</div>
                      <button onClick={() => { setLoginErr(""); setIdIn(""); setPinIn(""); setView("search"); }}
                        style={{ padding:"7px 13px", background:"none", border:`1.5px solid ${C.border}`, borderRadius:20, fontSize:11, fontWeight:700, color:C.textMid, cursor:"pointer", fontFamily:FF }}>
                        ← 홈으로 돌아가기
                      </button>
                    </div>
                  )}
              ...
              {user && (
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:10 }}>
                  <span style={{ fontSize:11, color:C.textMuted, display:"inline-flex", alignItems:"center", gap:4 }}>{Ic.user(C.textMuted,12)} {user.name} · 기록이 저장돼요</span>
          ...
          <div>
            <div style={{ fontSize:15, fontWeight:800, color:C.text, marginBottom:12, display:"flex", alignItems:"center", gap:6 }}>{Ic.book(C.woodDark, 17)} 내 책꽂이</div>
            {favs.length === 0 ? (
          ...
          <div>
            ...
            {!results.length && !loading && (
              <div style={{ marginBottom:16 }}>
                <div style={{ fontSize:12, fontWeight:700, color:C.textMuted, marginBottom:8, display:"flex", alignItems:"center", gap:5 }}>{Ic.book(C.textMuted, 14)} 인기 원서 바로 검색</div>
                <div style={{ display:"flex", flexWrap:"wrap", gap:7 }}>
                  {POPULAR.map((b, i) => (
            ...
            {loading && (
              <div style={{ textAlign:"center", padding:"60px 20px", color:C.textMid, fontSize:14 }}>
                <div style={{ display:"flex", justifyContent:"center", marginBottom:10 }}>{Ic.book(C.textMuted, 36)}</div>
                부엉이가 책장을 넘기는 중…
              </div>
            )}
            {/* 에러 */}
            ...
            {results.length > 0 && (
              <div>
                <div style={{ fontSize:13, color:C.textMid, marginBottom:12 }}>
                  <b style={{ color:C.wood }}>"{q}"</b> <span style={{ display:"inline-flex", alignItems:"center", gap:5 }}>{Ic.headphone(C.wood,14)} {searchMode === "listen" ? `흘려듣기 영상 ${results.length}편` : searchMode === "ch" ? `추천 영상 ${results.length}편` : `낭독 영상 ${results.length}권`}</span>
                </div>
                <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(240px, 1fr))", gap:16 }}>
            ...
            {!results.length && !loading && !error && (
              <div style={{ background:C.paper, borderRadius:14, padding:"24px 20px", border:`1.5px solid ${C.border}`, textAlign:"center", boxShadow:"3px 4px 0 rgba(107,124,96,0.1)" }}>
                <div style={{ display:"flex", justifyContent:"center", gap:14, marginBottom:12 }}>{Ic.book(C.wood,30)}{Ic.headphone("#D9C286",30)}</div>
